...
¿Cuál es el descuento promedio por categoría? (fórmulas)
¿Cuántas órdenes hay en cada región? (fórmulas)
...
Furniture tiene el descuento promedio más alto (17.4%), lo que podría explicar por qué varios de sus productos tienen ganancia negativa.
West también lidera en número de órdenes (3,203).
La ganancia total creció cada año: de $49,544 en 2014 a $93,439 en 2017.
California concentra la mayor cantidad de órdenes únicas (1,021), casi el doble que Nueva York, el segundo lugar.
Noviembre es el mes con más órdenes (1,213), seguido de septiembre y diciembre — consistente con la temporada de descuentos de fin de año.

Todos estos resultados coinciden con los obtenidos en el proyecto equivalente en SQL, lo cual confirma que el análisis es consistente sin importar la herramienta.
